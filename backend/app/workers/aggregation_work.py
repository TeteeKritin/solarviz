...
READING_INTERVAL_SECONDS = 60  # Assume readings every 60s
...
def run_daily_aggregation(target_date: date = None):
    ...
    try:
        ...
        self_consumed_kwh = solar_kwh - grid_export_kwh
        ...
        if existing:
            ...
            existing.self_consumed_kwh = max(0, self_consumed_kwh)
            ...
            db.add(DailySummary(
                ...
                self_consumed_kwh=max(0, self_consumed_kwh),
